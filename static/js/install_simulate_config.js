		...
		,"en":{
			...
			,"steps":
				[
				 ...
				 ,"<br/>Initialize compulated, You may login the system by: <a href='../html/desktop.html' target='_blank'>首页</a> 帐号密码都是 admin,<br/><br/>Or , if you are new to the system , you may t <a href='../html/simulate.html' target='_blank'>simulate a large data for the system first </a> "
				 ]
			 ,"database":{
		          "name":"Name"
		         ,"port":"Port"
